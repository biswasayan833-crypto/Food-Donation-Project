      ...
      <div className="max-w-xl w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-slate-200/90 shadow-xl shadow-slate-200/40">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-slate-500 mt-1">
            Join the Food Donation & Rescue Network
          </p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <p className="text-[11px] text-slate-500">
                  Restaurants, cafes, bakeries, grocery stores, caterers
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-500">
                  Food banks, shelters, soup kitchens, non-profits
                </p>
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g., Downtown Community Bakery"
